...
//$jobType = $_POST['jobType1'];
//$jobDescription = $_POST['jobDescription1'];
...
$retrieveid = "SELECT recruiterid FROM Recruiter WHERE recruitername = '$name2';";
$result = $conn->query($retrieveid);
$recid = $result->fetch_row()[0];


// insert opportunity info into database
$sql2 = "INSERT INTO Opportunity (opportunityid, jobposition, jobtype, recruiterid, jobdescription)
VALUES (NULL, '$position', '$jobType', '$recid', '$jobDescription')";
